...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='./', help='path to processed data')
    ...
    for split in splits:
        ...
        # -- load JSONS 
        info = json.load(open('SMNet/semmap_GT_info.json','r'))
        ...
        SAVE_DIR = f'/home/nicolas/hpc-home/allocentric_memory/Matterport/processed_data/{split}/'
        # SAVE_DIR = f'/home/nicolas/hpc-home/allocentric_memory/Matterport/processed_data/dummy/'
        ...
        for env in envs:
            ...
            with torch.no_grad():
                for n in tqdm(range(N)):
                    ...
                    # reset habitat and projector due to memory contraints
                    # if n%2000==0:
