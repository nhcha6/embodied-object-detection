...
class SMNet(nn.Module):
    ...
    def encode(self, features, proj_wtm, mask_outliers, heights, map_height, map_width):
        ...
        # print(proj_wtm.shape)
        # print(mask_outliers.shape)
        # print(heights.shape)
    ...
    def forward(self, features, proj_wtm, mask_outliers, heights, map_height, map_width, return_mem = False):
        ...
        if return_mem:
            return semmap_scores, observed_masks, height_map, memory
        else:
